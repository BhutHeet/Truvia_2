...
export const categories: Category[] = [
  {
    ...
    series: [
      ...
      },
      {
        ...
        category: "PTMT Taps",
        categorySlug: "ptmt-taps",
        description: "Luxurious marble-finish taps coming soon - Stay tuned for elegant bathroom aesthetics",
        tagline: "Coming Soon",
        products: [],
      },
      {
      ...
      },
      {
        ...
        category: "PTMT Taps",
        categorySlug: "ptmt-taps",
        description: "Classic T-Head design taps coming soon - Stay tuned for traditional elegance",
        tagline: "Coming Soon",
        products: [],
      },
    ],
